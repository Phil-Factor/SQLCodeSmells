...
https://documentation.red-gate.com/codeanalysis/best-practice-rules/bp010BP010[Usage of @@identity]
...
https://documentation.red-gate.com/codeanalysis/best-practice-rules/bp005BP005[Asterisk in select list]
